<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-07-01T19:12:32Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-06-27` Pushed to [yasyf/homebrew-tap](https://github.com/yasyf/homebrew-tap) — rolled the latest cask and formula bumps for reposync, cookiesync, and synckitd
- `2026-06-27` Pushed to [yasyf/fusekit](https://github.com/yasyf/fusekit) — threaded ExecPath into the holder probe and made mount teardown graceful-only with a more lenient liveness check
- `2026-06-27` Pushed to [yasyf/reposync](https://github.com/yasyf/reposync) — bumped to synckit v0.4.2 for Hosts-tab seed + revalidate, on top of the shared-TUI adoption
...
- `2026-06-27` Pushed to [yasyf/cc-pool](https://github.com/yasyf/cc-pool) — bumped to fusekit v0.21.0 for holder come-up and dropped the dead -tags fuse build variant, going fully pure-Go
