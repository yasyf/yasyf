<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-09T05:02:00Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-05` Pushed to [yasyf/captain-hook](https://github.com/yasyf/captain-hook) — read the hook version from Info.plist, sparing every hook two execve
...
- `2026-09-05` Created something new in [yasyf/cc-context](https://github.com/yasyf/cc-context)
- `2026-09-04` Pushed to [yasyf/cc-review](https://github.com/yasyf/cc-review)
- `2026-09-04` Pushed to [yasyf/cc-orchestrate](https://github.com/yasyf/cc-orchestrate) — picked up daemonkit v0.23.0, moving daemon state under ~/.daemonkit

**23,373 contributions in the last year**
