<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-25T05:14:14Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-25` Pushed to [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — pinned binrun v0.7.0 for signed-app copy_exec in the guides
...
- `2026-09-25` Worked on a pull request in [yasyf/spawnllm](https://github.com/yasyf/spawnllm)
- `2026-09-24` Created something new in [yasyf/cc-notes](https://github.com/yasyf/cc-notes)

**29,819 contributions in the last year**
...
- `2026-09-25` [captain-hook v12.57.0](https://github.com/yasyf/captain-hook/releases/tag/v12.57.0)
- `2026-09-25` [cc-context v0.65.2](https://github.com/yasyf/cc-context/releases/tag/v0.65.2)
