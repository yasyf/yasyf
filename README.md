<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-08-18T06:49:28Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-08-18` Pushed to [yasyf/homebrew-tap](https://github.com/yasyf/homebrew-tap) — published the slop-cop v0.1.62, captain-hook v12.21.3, cc-pool v0.65.2, and cc-patch v0.14.0 formulae
- `2026-08-18` Pushed to [yasyf/captain-hook](https://github.com/yasyf/captain-hook) — repinned the publisher SHA the release contract asserts, and migrated the MCP server to mcp 2.x
- `2026-08-17` Pushed to [yasyf/cc-context](https://github.com/yasyf/cc-context)
...
**19,479 contributions in the last year**
...
- `2026-08-18` [captain-hook v12.21.4](https://github.com/yasyf/captain-hook/releases/tag/v12.21.4)
