<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-25T12:05:24Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-25` Discussed issues in [yasyf/cc-context](https://github.com/yasyf/cc-context)
...
- `2026-09-25` Worked on a pull request in [stablyai/orca](https://github.com/stablyai/orca)

**30,079 contributions in the last year**
...
- `2026-09-25` [cc-context v0.65.10](https://github.com/yasyf/cc-context/releases/tag/v0.65.10)
