<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-14T16:01:37Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-14` Pushed to [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — pinned binrun v0.6.0 in the guides for signed-app minimum versions
- `2026-09-14` Worked on a pull request in [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — pinned binrun v0.5.1 so python-tool installs refresh uv's index
...
- `2026-09-14` Worked on a pull request in [yasyf/binrun](https://github.com/yasyf/binrun) — took daemonkit v0.28.0, so a signed app can require a minimum version

**24,398 contributions in the last year**
...
- `2026-09-14` [captain-hook v12.28.1](https://github.com/yasyf/captain-hook/releases/tag/v12.28.1) — dropped stapler from the Homebrew formula sandbox
- `2026-09-09` [cc-context v0.58.0](https://github.com/yasyf/cc-context/releases/tag/v0.58.0) — committed and restacked the graphite lane without gt
