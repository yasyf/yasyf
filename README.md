<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-07-18T10:51:28Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-07-18` Pushed to [yasyf/cc-transcript](https://github.com/yasyf/cc-transcript) — enumerated word- and argument-position command substitutions
- `2026-07-18` Pushed to [yasyf/homebrew-tap](https://github.com/yasyf/homebrew-tap)
- `2026-07-18` Pushed to [yasyf/yclaw](https://github.com/yasyf/yclaw) — gave hermes a container-native OCI image with a secret-injection entrypoint
- `2026-07-18` Pushed to [yasyf/synckit](https://github.com/yasyf/synckit) — extracted registry-backed mesh trust into a meshtrust package
- `2026-07-18` Pushed to [yasyf/spawnllm](https://github.com/yasyf/spawnllm) — added a cross-language conformance vector pipeline
- `2026-07-18` Pushed to [yasyf/slop-cop](https://github.com/yasyf/slop-cop)
- `2026-07-18` Pushed to [yasyf/semisweet](https://github.com/yasyf/semisweet)
- `2026-07-18` Pushed to [yasyf/reposync](https://github.com/yasyf/reposync) — exposed the repo registry as a public read-only package
- `2026-07-18` Pushed to [yasyf/getaway](https://github.com/yasyf/getaway) — re-keyed seat-advice verdicts on the researcher-reported operating carrier
- `2026-07-18` Pushed to [yasyf/fusekit](https://github.com/yasyf/fusekit)
- `2026-07-18` Pushed to [yasyf/experiment-at-home](https://github.com/yasyf/experiment-at-home) — added TinkerBackend.sample() and threaded sampler_path through the adapter
- `2026-07-18` Pushed to [yasyf/docker-dsl](https://github.com/yasyf/docker-dsl)

**14,099 contributions in the last year**
...
- `2026-07-18` [captain-hook v10.1.0](https://github.com/yasyf/captain-hook/releases/tag/v10.1.0) — added a performance pack of speculate-while-you-verify pipelining nudges
- `2026-07-18` [spawnllm v0.7.0](https://github.com/yasyf/spawnllm/releases/tag/v0.7.0) — typed ClaudeConfig.tools as a tuple toolset selection
