<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-08-30T12:08:36Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-08-30` Pushed to [yasyf/captain-hook](https://github.com/yasyf/captain-hook) — serialized lexicon reads, so dispatch threads stop sharing one sqlite statement
...
- `2026-08-30` Pushed to [yasyf/synckit](https://github.com/yasyf/synckit)
- `2026-08-30` Pushed to [yasyf/cc-interact](https://github.com/yasyf/cc-interact)
...
**21,578 contributions in the last year**
...
- `2026-08-30` [captain-hook v12.22.5](https://github.com/yasyf/captain-hook/releases/tag/v12.22.5)
