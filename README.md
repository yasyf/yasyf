<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-06-25T01:25:21Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-06-25` Pushed to [yasyf/cookiesync](https://github.com/yasyf/cookiesync)
...
- `2026-06-24` Pushed to [yasyf/homebrew-tap](https://github.com/yasyf/homebrew-tap)
- `2026-06-24` Pushed to [yasyf/reposync](https://github.com/yasyf/reposync)
...
**9,496 contributions in the last year**
...
- `2026-06-25` [captain-hook v4.1.0](https://github.com/yasyf/captain-hook/releases/tag/v4.1.0)
- `2026-06-24` [cookiesync v0.3.0](https://github.com/yasyf/cookiesync/releases/tag/v0.3.0)
