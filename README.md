<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-15T14:28:41Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-15` Was active in [yasyf/cc-skills](https://github.com/yasyf/cc-skills)
- `2026-09-15` Discussed issues in [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — bumped codex and slop-cop for the per-tag binrun runner
...
- `2026-09-15` Pushed to [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — gave each pinned binrun tag its own runner path in the guides
...
- `2026-09-14` Worked on a pull request in [yasyf/spawnllm](https://github.com/yasyf/spawnllm) — resolved the small and medium codex tiers to gpt-5.6-luna
- `2026-09-14` Worked on a pull request in [yasyf/cc-transcript](https://github.com/yasyf/cc-transcript) — answered deep predicates from held inputs instead of held lifts

**25,096 contributions in the last year**
...
- `2026-09-15` [captain-hook v12.30.11](https://github.com/yasyf/captain-hook/releases/tag/v12.30.11) — read a removed root's plugin roster from its nearest surviving ancestor
...
- `2026-08-30` [cc-orchestrate v0.17.0](https://github.com/yasyf/cc-orchestrate/releases/tag/v0.17.0) — took daemonkit v0.23.0, moving daemon state under ~/.daemonkit/a/<label>
