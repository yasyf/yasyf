<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-02T11:35:45Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- Cutting that substrate through to releases: [cc-review](https://github.com/yasyf/cc-review) cut v0.35.0 on daemonkit v0.23.0 and [cc-runtime](https://github.com/yasyf/cc-runtime) cut 0.18.0 onto the same surface, cc-orchestrate runs its pty hosts as Serve products under one Daemon, and [binrun](https://github.com/yasyf/binrun) gates every release on a tag resolving to one exact commit on main
...
- `2026-09-02` Worked on a pull request in [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — added a cc-present block pack for the design-doc interview rounds
- `2026-09-02` Worked on a pull request in [yasyf/captain-hook](https://github.com/yasyf/captain-hook)
...
- `2026-09-01` Was active in [yasyf/cc-interact](https://github.com/yasyf/cc-interact)
...
**22,743 contributions in the last year**
...
- `2026-09-02` [captain-hook v12.23.0](https://github.com/yasyf/captain-hook/releases/tag/v12.23.0)
