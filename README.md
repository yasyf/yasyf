<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-15T11:59:43Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-15` Discussed issues in [yasyf/cc-skills](https://github.com/yasyf/cc-skills)
...
- `2026-09-15` Pushed to [yasyf/binrun](https://github.com/yasyf/binrun)
- `2026-09-15` Worked on a pull request in [yasyf/binrun](https://github.com/yasyf/binrun) — took daemonkit v0.28.0, so a signed app can require a minimum version
...
**25,017 contributions in the last year**
...
- `2026-09-15` [captain-hook v12.30.11](https://github.com/yasyf/captain-hook/releases/tag/v12.30.11)
