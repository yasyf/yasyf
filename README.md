<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-07-13T19:59:10Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-07-13` Pushed to [yasyf/cc-steer](https://github.com/yasyf/cc-steer)
...
- `2026-07-13` Pushed to [yasyf/cc-notes](https://github.com/yasyf/cc-notes)
...
- `2026-07-13` Pushed to [yasyf/cc-transcript](https://github.com/yasyf/cc-transcript)
...
**12,130 contributions in the last year**
...
- `2026-07-13` [captain-hook v9.11.0](https://github.com/yasyf/captain-hook/releases/tag/v9.11.0)
- `2026-07-13` [synckit v0.11.0](https://github.com/yasyf/synckit/releases/tag/v0.11.0)
