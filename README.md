...
- `2026-06-26` Pushed to [yasyf/cookiesync](https://github.com/yasyf/cookiesync) — adopted synckitd and rode reposync's host mesh for self and peers
- `2026-06-26` Pushed to [yasyf/reposync](https://github.com/yasyf/reposync) — adopted synckitd and rode synckit's generic watch, RPC, and service engines
- `2026-06-26` Pushed to [yasyf/synckit](https://github.com/yasyf/synckit) — shipped synckitd, a multi-consumer sync daemon over an LWW-Element-Set CRDT
