<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-16T11:56:39Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-16` Pushed to [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — gave each pinned binrun tag its own runner path in the guides
- `2026-09-16` Pushed to [yasyf/homebrew-tap](https://github.com/yasyf/homebrew-tap) — bumped the captain-hook formula to v12.30.9
- `2026-09-16` Worked on a pull request in [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — taught open-pr's watcher to see a Graphite queue drop
...
- `2026-09-16` Worked on a pull request in [yasyf/cc-transcript](https://github.com/yasyf/cc-transcript) — answered deep predicates from held inputs instead of held lifts
- `2026-09-16` Worked on a pull request in [yasyf/captain-hook](https://github.com/yasyf/captain-hook) — gave a release ten minutes to show up in PyPI's index before CI calls it failed
- `2026-09-16` Pushed to [yasyf/cc-notes](https://github.com/yasyf/cc-notes)
- `2026-09-16` Pushed to [yasyf/captain-hook](https://github.com/yasyf/captain-hook) — kept hookd working when a root is deleted underneath it, from its cwd to its plugin roster
- `2026-09-16` Created something new in [yasyf/cc-transcript](https://github.com/yasyf/cc-transcript)
- `2026-09-16` Created something new in [yasyf/captain-hook](https://github.com/yasyf/captain-hook)
- `2026-09-16` Worked on a pull request in [yasyf/daemonkit](https://github.com/yasyf/daemonkit) — kept one settlement grace for a kill, and named the abort that restored the incumbent

**26,074 contributions in the last year**
...
- `2026-09-16` [cc-skills v1.12.4](https://github.com/yasyf/cc-skills/releases/tag/v1.12.4)
- `2026-09-16` [cc-transcript v14.18.0](https://github.com/yasyf/cc-transcript/releases/tag/v14.18.0)
- `2026-09-16` [captain-hook v12.37.0](https://github.com/yasyf/captain-hook/releases/tag/v12.37.0)
- `2026-09-16` [cc-notes v0.53.1](https://github.com/yasyf/cc-notes/releases/tag/v0.53.1)
