<!-- gh-profile:meta {"intensity": "fancy", "last_refresh": "2026-09-09T11:44:18Z", "min_contributions": 750, "min_stars_badge": 30, "shipped_window_months": 6, "skill_version": "0.2.0"} -->
...
- `2026-09-09` Pushed to [yasyf/cc-context](https://github.com/yasyf/cc-context) — fixed graphite submit to open one pull request per call, the way gt does
- `2026-09-09` Worked on a pull request in [yasyf/cc-context](https://github.com/yasyf/cc-context) — anchored the graphite submit on the remote trunk, dropping the branches it already holds
- `2026-09-08` Pushed to [yasyf/cc-skills](https://github.com/yasyf/cc-skills) — landed design-doc v0.17.0 and incident-retro v0.1.0 on partials the two now share
...
- `2026-09-03` Worked on a pull request in [yasyf/captain-hook](https://github.com/yasyf/captain-hook)
...
**23,428 contributions in the last year**
